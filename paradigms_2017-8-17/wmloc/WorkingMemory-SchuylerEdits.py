...
dim = finalResp.shape
datafile = u'data/Data_%s_%s%s_RandCon%s_%s_%s_events.txt' %(expInfo['participant'], expInfo['randomization'], expInfo['session'], runRandomization, expName, expInfo['date'])
f = open(datafile,'w')
f.write(
    'block' + '\t' + 
    'trial' + '\t' + 
...
blocktype = ['2-back', '0-back']*int(nBlocks/2)
datafile = u'data/Data_%s_%s%s_RandCon%s_%s_%s_blocks.txt' %(expInfo['participant'], expInfo['randomization'], expInfo['session'], runRandomization, expName, expInfo['date'])
f = open(datafile,'w')
f.write(
        'trial_startTime' + '\t' + 
        'trial_type' + '\n')
